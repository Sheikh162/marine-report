...
export default async function UserSingleReportPage({ params }: { params: Promise<{ reportId: string }> }) {
  ...
  return (
    <div className="container mx-auto py-8">
      <PageHeader title="Your Submitted Report"/>
        <Button asChild>
      ...
      <div className="space-y-8">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <DetailItem label="Draft Before (in meters)" value={validatedReport.draftBefore} />
            <DetailItem label="Draft Aft (in meters)" value={validatedReport.draftAft} />
